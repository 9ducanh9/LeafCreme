...
import { createSePayPayment } from '../services/paymentService'
...
export default function CheckoutPage() {
  ...
  const [paymentMethod, setPaymentMethod] = useState<'pay_later' | 'sepay_qr'>('pay_later')
